...
-fit.DAO.DAOMachine;
-fit.DAO.DAOProfil;
-fit.DAO.DatabaseHelper;
-fit.DAO.Fonte;
-fit.DAO.Machine;
-fit.DAO.Profile;
-fit.DAO.bodymeasures.BodyMeasure;
-fit.DAO.bodymeasures.DAOBodyMeasure;
-fit.DAO.cardio.DAOOldCardio;
-fit.DAO.cardio.OldCardio;
-fit.bodymeasures.BodyPartListFragment;
-fit.fonte.FontesPagerFragment;
-fit.intro.MainIntroActivity;
-fit.machines.MachineFragment;
-fit.utils.CustomExceptionHandler;
-fit.utils.FileChooserDialog;
-fit.utils.ImageUtil;
import com.health-fit.utils.MusicController;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        File folder = new File(Environment.getExternalStorageDirectory() + "/healthfit");
        boolean success = true;
        if (!folder.exists()) {
            success = folder.mkdir();
        }
        if (success) {
            folder = new File(Environment.getExternalStorageDirectory() + "/healthfit/crashreport");
            success = folder.mkdir();
        }
        ...
        if (folder.exists()) {
            if (!(Thread.getDefaultUncaughtExceptionHandler() instanceof CustomExceptionHandler)) {
                Thread.setDefaultUncaughtExceptionHandler(new CustomExceptionHandler(
                    Environment.getExternalStorageDirectory() + "/healthfit/crashreport"));
            }
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.import_database:
                ...
                fileChooserDialog.chooseDirectory(Environment.getExternalStorageDirectory() + "/healthfit/export");
                return true;
